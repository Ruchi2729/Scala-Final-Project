...
// add the SVG element
var svg = d3.select("#char1").append("svg")
...
// add the SVG element
var svg0 = d3.select("#char2").append("svg")
    .attr("width", width + margin.left + margin.right)
    .attr("height", height + margin.top + margin.bottom)
  .append("g")
    .attr("transform",
...
// add the SVG element
var svg1 = d3.select("#char3").append("svg")
    .attr("width", width + margin.left + margin.right)
    .attr("height", height + margin.top + margin.bottom)
  .append("g")
    .attr("transform",
...
// load the data
d3.json("/assets/BookingsByEachUser.json", function(error, data) {
