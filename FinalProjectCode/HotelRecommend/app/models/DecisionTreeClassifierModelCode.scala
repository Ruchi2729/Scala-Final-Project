...
//
//    model.write.save("G:\\7200\\Ruchira\\modelDecisionTree2")

 val model1=PipelineModel.read.load("G:\\7200\\Ruchira\\modelDecisionTree2")
 testTheModel(model1,"C:\\Users\\sweta\\Desktop\\export.csv")
