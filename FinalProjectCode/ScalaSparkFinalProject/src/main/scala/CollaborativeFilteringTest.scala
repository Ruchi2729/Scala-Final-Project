...
case class User2(userId: Int, hotelClusterId: Int,srch_destination_id:Int,srch_adults_cnt:Int, isBooking: Float)
...
object CollaborativeFilteringTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    def parseRating(str: String): User2 = {
      val fields = str.split(",")
      assert(fields.size == 24)
      User2(fields(7).toInt, fields(23).toInt, fields(16).toInt,fields(13).toInt, fields(18).toFloat)
    }
